...
# python tools/train.py -d cloud_tc --lr 1e-3 -c configs/cloud/SimVP_gSTA.py --ex_name h8tc_simvp_gsta_0424
# CUDA_VISIBLE_DEVICES=0 python tools/train.py -d meteo -c configs/meteo/MMVP.py --ex_name meteo_mmvp_0427
CUDA_VISIBLE_DEVICES=0 python tools/train.py -d h8_17x -c configs/h8_17x/PredRNN.py --ex_name h8_17x_predrnn_0723
```
