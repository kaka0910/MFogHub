...
class H817xDataset(Dataset):

    def __init__(self, X, Y, use_augment=False, data_name='h8_17x'):
        super(H817xDataset, self).__init__()
...
def load_data(batch_size, val_batch_size, data_root, num_workers=1,
    ...
    train_set = H817xDataset(X=X_train, Y=Y_train, use_augment=False)
    test_set = H817xDataset(X=X_test, Y=Y_test, use_augment=False)
